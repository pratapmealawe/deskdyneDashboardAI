...
@Component({
  selector: 'app-vendor-firm-admin-bulk-order-report',
  templateUrl: './vendor-firm-admin-bulk-order-report.component.html',
  styleUrls: ['./vendor-firm-admin-bulk-order-report.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
...
export class VendorFirmAdminBulkOrderReportComponent implements OnInit {
