...
@Component({
  selector: 'app-vendor-firm-wallet-txn-dialog',
  templateUrl: './vendor-firm-wallet-txn-dialog.component.html',
  styleUrls: ['./vendor-firm-wallet-txn-dialog.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
...
export class VendorFirmWalletTxnDialogComponent {
  form: FormGroup;
  loading = false;

  constructor(
    @Inject(MAT_DIALOG_DATA) public data: WalletTxnDialogData,
    private dialogRef: MatDialogRef<VendorFirmWalletTxnDialogComponent, WalletTxnDialogResult>,
