...
import { WalletTransactionHistoryComponent } from 'src/app/vendor-management/vendor-firm/vendor-firm-view/wallet-transaction-history/wallet-transaction-history.component';

@Component({
  selector: 'app-vendor-firm-wallet-details',
  templateUrl: './vendor-firm-wallet-details.component.html',
  styleUrls: ['./vendor-firm-wallet-details.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
