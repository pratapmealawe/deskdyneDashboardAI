...
@Component({
  selector: 'app-add-edit-virtual-cafeteria-categories-weekly-menu',
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule],
  templateUrl: './add-edit-virtual-cafeteria-categories-weekly-menu.component.html',
  styleUrls: ['./add-edit-virtual-cafeteria-categories-weekly-menu.component.scss']
})
export class AddEditVirtualCafeteriaCategoriesWeeklyMenuComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddEditVirtualCafeteriaCategoriesWeeklyMenuComponent>,
  ...
  async getVirtualCafeteriaByCafeteria(): Promise<void> {
    try {
      let value = await this.apiMainService.getVirtualCafeteriaPackageByCafeteria(this.selectedCafeteria._id);
      this.weekMenuList = [];
