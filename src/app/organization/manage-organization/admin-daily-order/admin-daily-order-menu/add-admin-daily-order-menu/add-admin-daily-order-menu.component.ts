...
@Component({
  selector: 'app-add-admin-daily-order-menu',
  standalone: true,
  imports: [CommonModule, MaterialModule, ReactiveFormsModule, DirectivesModule],
  templateUrl: './add-admin-daily-order-menu.component.html',
  styleUrls: ['./add-admin-daily-order-menu.component.scss']
})
export class AddAdminDailyOrderMenuComponent implements OnInit {
  mealTypeOptions = [
  ...
  constructor(
    private dialogRef: MatDialogRef<AddAdminDailyOrderMenuComponent>,
