...
@Component({
  selector: 'app-copy-admin-daily-order-menu',
  standalone: true,
  imports: [CommonModule, MaterialModule, ReactiveFormsModule],
  templateUrl: './copy-admin-daily-order-menu.component.html',
  styleUrls: ['./copy-admin-daily-order-menu.component.scss']
})
export class CopyAdminDailyOrderMenuComponent {
  ...
  constructor(
    private dialogRef: MatDialogRef<CopyAdminDailyOrderMenuComponent>,
