...
import { CopyAdminDailyOrderMenuComponent } from './copy-admin-daily-order-menu/copy-admin-daily-order-menu.component';
import { ImportAdminDailyOrderMenuComponent } from './import-admin-daily-order-menu/import-admin-daily-order-menu.component';
...
@Component({
  selector: 'app-admin-daily-order-menu',
  standalone: true,
  imports: [CommonModule, FormsModule, MaterialModule],
  templateUrl: './admin-daily-order-menu.component.html',
  styleUrls: ['./admin-daily-order-menu.component.scss']
})
export class AdminDailyOrderMenuComponent implements OnInit {
  @Input() orgObj: any;
  ...
  addDeliverySettings() {
    ...
    this.openModal(AddAdminDailyOrderMenuComponent, payload);
  }
  ...
  onAddSubMenu(selectedMealType: any) {
    ...
    this.openModal(AddAdminSubTypeDailyOrderMenuComponent, payload);
  }
  ...
  assignVendor() {
    ...
    this.openModal(AddAdminVendorDailyOrderMenuComponent, payload);
  }
  ...
  copyMenu() {
    ...
    const dialogRef = this.modalService.open(CopyAdminDailyOrderMenuComponent, {
      width: '1000px',
      data: payload,
      autoFocus: true,
      disableClose: false
  ...
  importMenu() {
    ...
    const dialogRef = this.modalService.open(ImportAdminDailyOrderMenuComponent, {
      width: '800px',
      data: payload,
      autoFocus: true,
      disableClose: false
