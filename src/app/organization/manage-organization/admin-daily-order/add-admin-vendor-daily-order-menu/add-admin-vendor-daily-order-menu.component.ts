...
@Component({
  selector: 'app-add-admin-vendor-daily-order-menu',
  standalone: true,
  imports: [CommonModule, MaterialModule, ReactiveFormsModule],
  templateUrl: './add-admin-vendor-daily-order-menu.component.html',
  styleUrls: ['./add-admin-vendor-daily-order-menu.component.scss']
})
export class AddAdminVendorDailyOrderMenuComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<AddAdminVendorDailyOrderMenuComponent>,
