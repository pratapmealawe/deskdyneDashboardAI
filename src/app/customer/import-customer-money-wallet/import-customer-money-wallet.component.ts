...
@Component({
    selector: 'app-import-customer-money-wallet',
    templateUrl: './import-customer-money-wallet.component.html',
    styleUrls: ['./import-customer-money-wallet.component.scss'],
    standalone: true,
    imports: [CommonModule, MaterialModule]
})
export class ImportCustomerMoneyWalletComponent {
    orgId: string = '';
    customerList: any[] = [];
    isUploading = false;
    fileName: string = '';
    ...
    constructor(
        public dialogRef: MatDialogRef<ImportCustomerMoneyWalletComponent>,
