...
export interface VendorFirmItemBreakdownDialogData {
  orders: any[];
  rangeLabel?: string;
...
@Component({
  selector: 'app-vendor-firm-item-breakdown',
  templateUrl: './vendor-firm-item-breakdown.component.html',
  styleUrls: ['./vendor-firm-item-breakdown.component.scss'],
  standalone: true,
  imports: [CommonModule, MaterialModule]
})
export class VendorFirmItemBreakdownComponent {
  orders: any[] = [];
