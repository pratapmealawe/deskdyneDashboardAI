...
@Component({
  selector: 'app-vendor-firm-report',
  templateUrl: './vendor-firm-report.component.html',
  styleUrls: ['./vendor-firm-report.component.scss'],
  standalone: true,
...
export class VendorFirmReportComponent {
