...
@Component({
  selector: 'app-vendor-daily-report',
  templateUrl: './vendor-daily-report.component.html',
  styleUrls: ['./vendor-daily-report.component.scss'],
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule, ReactiveFormsModule]
})
export class VendorDailyReportComponent implements OnInit {
