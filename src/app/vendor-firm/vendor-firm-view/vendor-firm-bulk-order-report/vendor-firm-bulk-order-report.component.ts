...
@Component({
  selector: 'app-vendor-firm-bulk-order-report',
  templateUrl: './vendor-firm-bulk-order-report.component.html',
  styleUrls: ['./vendor-firm-bulk-order-report.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
...
export class VendorFirmBulkOrderReportComponent implements OnInit {
