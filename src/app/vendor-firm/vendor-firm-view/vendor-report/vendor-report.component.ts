...
import { CommonOutletCafeSelectComponent } from '../../../common-outlet-cafe-select/common-outlet-cafe-select.component';
import { DatewiseOrdersDialogComponent } from '../../../billing/datewise-orders-dialog/datewise-orders-dialog.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule, ReactiveFormsModule, ItemBreakdownComponent, CommonOutletCafeSelectComponent, DatewiseOrdersDialogComponent]
})
