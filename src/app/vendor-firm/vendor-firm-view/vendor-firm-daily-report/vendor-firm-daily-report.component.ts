...
@Component({
  selector: 'app-vendor-firm-daily-report',
  templateUrl: './vendor-firm-daily-report.component.html',
  styleUrls: ['./vendor-firm-daily-report.component.scss'],
  standalone: true,
  imports: [CommonModule, MaterialModule, FormsModule, ReactiveFormsModule]
})
export class VendorFirmDailyReportComponent implements OnInit {
