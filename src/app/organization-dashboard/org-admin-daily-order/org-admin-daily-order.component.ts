...
@Component({
  selector: 'app-org-admin-daily-order',
  templateUrl: './org-admin-daily-order.component.html',
  styleUrls: ['./org-admin-daily-order.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class OrgAdminDailyOrderComponent implements OnInit {
