...
export class ApiConfigService {
  ...
  private mlBaseUrl: string = environment.mlServerUrl;
  apiEndPointObj: any;
  constructor() {
    this.init();
  }
  private init() {
    ...
    const m = (path: string, method: string) => ({ url: `${this.mlBaseUrl}${path}`, method });
    this.apiEndPointObj = {
      ...
      saveEventPopup: p('/api/saveEventPopup', 'POST'),
      updateEventPopup: p('/api/updateEventPopup', 'PUT'),
      getEventPopups: p('/api/getEventPopups', 'GET'),
      getEventPopupsById: p('/api/getEventPopupsById', 'GET'),
      deleteEventPopup: p('/api/deleteEventPopup', 'DELETE'),
      toggleEventPopupStatus: p('/api/toggleEventPopupStatus', 'PATCH'),
      ...
      addRole: p('/api/rbac/role', 'POST'),
      updateRole: p('/api/rbac/role', 'PUT'),
      deleteRole: p('/api/rbac/role', 'DELETE'),
      ...
      addOrg: p('/api/organization', 'POST'),
      orgUpdate: p('/api/org_update', 'POST'),
      updateOrglevelSubsidy: p('/api/org_updateOrglevelSubsidy', 'POST'),
      updateCafelevelSubsidy: p('/api/B2B_org_updateCafelevelSubsidy', 'POST'),
      fetchFilteredAllOrgs: p('/api/fetchFilteredAllOrgs', 'POST'),
      deleteOrganization: p('/api/deleteOrganization', 'DELETE'),
      getDeletedOrganizations: p('/api/getDeletedOrganizations', 'GET'),
      restoreOrganization: p('/api/restoreOrganization', 'POST'),
      deleteOutlet: p('/api/deleteOutlet', 'DELETE'),
      getDeletedOutlets: p('/api/getDeletedOutlets', 'GET'),
      restoreOutlet: p('/api/restoreOutlet', 'POST'),
      ...
      bulkMenu_fetchByCafe: p('/api/bulkMenu/fetchBulkMenu', 'GET'),
      bulkMenu_update: p('/api/bulkMenu/updateBulkMenu', 'POST'),
      bulkMenu_saveCategoryMenu: p('/api/bulkMenu/saveCategoryMenu', 'POST'),
      bulkMenu_getCategoryMenu: p('/api/bulkMenu/getCategoryMenu', 'POST'),
      getAllBulkMasterMenus: p('/api/getAllBulkMasterMenus', 'GET'),
      deleteBulkMasterMenu: p('/api/deleteBulkMasterMenu', 'POST'),
      bulkMasterMenu: p('/api/bulkMasterMenu', 'POST'),
      updateBulkMasterMenu: p('/api/updateBulkMasterMenu', 'POST'),
      ...
      virtualCafeteriaEmployeeAdd: p('/api/virtualCafeteriaEmployeeAdd', 'POST'),
      virtualCafeteriaEmployeeByOrgId: p('/api/getVirtualCafeteriaEmployeeByOrgId', 'GET'),
      virtualCafeteriaEmployeeAddList: p('/api/addVirtualCafeteriaEmployeeList', 'POST'),
      virtualCafeteriaEmployeeDelete: p('/api/deleteVirtualCafeteriaEmployee', 'DELETE'),
      virtualCafeteriaEmployeeUpdate: p('/api/updateVirtualCafeteriaEmployee', 'POST'),
      getVirtualCafeteriaEmployeeByPhoneNo: p('/api/getVirtualCafeteriaEmployeeByPhoneNo', 'GET'),
      virtualCafeteriaEmployeeVerifyByPhoneNo: p('/api/verifyVirtualCafeteriaEmployeeByPhoneNo', 'GET'),
      virtualCafeteriaEmployeeVerifyByEmail: p('/api/verifyVirtualCafeteriaEmployeeByEmail', 'GET'),
      ...
      getEventPopupsByOrgId: p('/api/getEventPopupsByOrgId', 'GET'),
      fetchDailyBulkOrdersbysearchObj: p('/api/fetchDailyBulkOrdersbysearchObj', 'POST'),
      fetchBulkOrdersByVendorFirmId: p('/api/fetchBulkOrdersByVendorFirmId', 'POST'),
      ...
      orgInfo: p('/api/org_info', 'POST'),
      bulkMenu_syncItem: p('/api/bulkMenu/syncBulkMenuItem', 'POST'),
      bulkMenu_updateVendor: p('/api/bulkMenu/updateVendorDetails', 'POST'),
      bulkMenu_copy: p('/api/bulkMenu/copyBulkMenu', 'POST'),
      bulkMenu_fetchByCategory: p('/api/bulkMenu/getBulkMenuByCategory', 'POST'),
      bulkMenu_toggleStatus: p('/api/bulkMenu/toggleCategoryStatus', 'POST'),
      bulkMenu_getVendorByFilter: p('/api/bulkMenu/getVendorDetailsByFilter', 'POST'),
      ...
      virtualCafeteriaCategoryAdd: p('/api/addVirtualCafeteriaCategory', 'POST'),
      virtualCafeteriaCategoryDelete: p('/api/deleteVirtualCafeteriaCategory', 'POST'),
      virtualCafeteriaCategoryUpdate: p('/api/updateVirtualCafeteriaCategory', 'POST'),
      virtualCafeteriaCategoryAddList: p('/api/addVirtualCafeteriaCategoryList', 'POST'),
      virtualCafeteriaBannerAdd: p('/api/addVirtualCafeteriaBannerImage', 'POST'),
      virtualCafeteriaBannerUpdateList: p('/api/updateVirtualCafeteriaBannerImages', 'POST'),
      virtualCafeteriaBannerDelete: p('/api/deleteVirtualCafeteriaBannerImage', 'POST'),
      virtualCafeteriaCategoriesByCafeteria: p('/api/getVirtualCafeteriaCategories', 'GET'),
      getVirtualCafeteriaDefaultCategories: p('/api/getVirtualCafeteriaDefaultCategories', 'GET'),
      updateVirtualCafeteriaWeeklyMenu: p('/api/updateWeeklyMenuCategory', 'POST'),
      updateVirtualCafeteriaCategoryConfig: p('/api/updateVirtualCafeteriaCategoryConfig', 'POST'),
      virtualCafeteriaPackageSave: p('/api/saveVirtualCafeteriaPackage', 'POST'),
      virtualCafeteriaPackageSaveList: p('/api/saveVirtualCafeteriaPackageList', 'POST'),
      virtualCafeteriaPackageUpdate: p('/api/updateVirtualCafeteriaPackage', 'POST'),
      virtualCafeteriaPackageByCafeteria: p('/api/getVirtualCafeteriaPackageByCafeteria', 'GET'),
      virtualCafeteriaPackageById: p('/api/getVirtualCafeteriaPackage', 'GET'),
      changeVirtualCafeteriaPackageStatus: p('/api/changeVirtualCafeteriaPackageStatus', 'POST'),
      deleteVirtualCafeteriaPackageItem: p('/api/deleteVirtualCafeteriaPackageItem', 'POST'),
      addVirtualCafeteriaPackageItem: p('/api/addVirtualCafeteriaPackageItem', 'POST'),
      updateVirtualCafeteriaPackageItem: p('/api/updateVirtualCafeteriaPackageItem', 'POST'),
      addVirtualCafeteriaBannerImage: p('/api/addVirtualCafeteriaBannerImage', 'POST'),
      updateVirtualCafeteriaBannerImages: p('/api/updateVirtualCafeteriaBannerImages', 'POST'),
      deleteVirtualCafeteriaBannerImage: p('/api/deleteVirtualCafeteriaBannerImage', 'POST'),
      addCategoryConfig: p('/api/addCategoryConfig', 'POST'),
      deleteCategoryConfig: p('/api/deleteCategoryConfig', 'POST'),
      changeVirtualCafeteriaCategoryStatus: p('/api/changeVirtualCafeteriaCategoryStatus', 'POST'),
      ...
      ml_getMealPackageList: m('/api/getMealPackageList', 'GET'),
      ml_getAllGeoFencingList: m('/api/getAllGeoFencingList', 'GET'),
      checkSession: p('/authadmin/checkSession', 'GET'),
      bulkMenu_fetchAll: p('/api/bulkMenu/fetchAllBulkMenus', 'GET'),
      bulkMenu_fetchByOrgAndCafe: p('/api/bulkMenu/getBulkMenuByOrgAndCafeteria', 'POST'),
      bulkMenu_add: p('/api/bulkMenu/addBulkMenu', 'POST'),
      bulkMenu_delete: p('/api/bulkMenu/deleteBulkMenu', 'DELETE'),
