...
export class MlApiMainService {
  ...
  getfoodItemsList(query: string, text: string) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${query}/${text}`, method: urlObj.method });
  }
  ...
  exportKitchenPartners(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.exportKitchenPartners, data);
  }
  ...
  activateGeoFencing(id: any, active: boolean) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${active}`, method: urlObj.method });
  }
  ...
  updatePendingOrdersProps(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.updatePendingOrdersProps, data);
  }

  getVariables(variableNames: any, from: string) {
    return this.runTimeCacheInterceptor('CONFIG_VARIABLE' + from, this.apiConfigService.apiEndPointObj.getVariable, { variableNames });
  }
  ...
  saveSubscriptionWeeklyMenu(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.saveSubscriptionWeeklyMenu, data)
  }

  searchSubscriptionWeeklyMenuList(data: any, page: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.searchSubscriptionWeeklyMenuList;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}`, method: urlObj.method }, data)
  }

  deleteSubscriptionWeeklyMenu(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.deleteSubscriptionWeeklyMenu;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }
  ...
  getCurrentOrdersCount() {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${this.getTodayStartDate()}`, method: urlObj.method });
  }
  ...
  getCurrentOrdersList(status: any, page: any, limit: number) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${this.getTodayStartDate()}/${page}/${limit}/${status}`, method: urlObj.method });
  }
  ...
  getGatewayPaymentHistory(paymentOrderid: string) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${paymentOrderid}`, method: urlObj.method });
  }
  ...
  refundGatewayPayment(id: string, orderType: string, data: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${orderType}`, method: urlObj.method }, data);
  }

  refundToUserWallet(id: string, orderType: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.refundToUserWallet;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${orderType}`, method: urlObj.method });
  }
  ...
  placePaymentFailedOrder(id: string, orderType: string, paymentId: string) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${orderType}/${paymentId}`, method: urlObj.method });
  }
  ...
  updateCouponList(mobile: string, coupon: string) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${mobile}/${coupon}`, method: urlObj.method });
  }
  ...
  getCustomerProfileByMobile(phone: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${phone}`, method: urlObj.method });
  }
  ...
  getNearestKitchen(pageNumber: any, lng: any, lat: any, data: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${pageNumber}/${lng}/${lat}`, method: urlObj.method }, data);
  }
  ...
  getOneConfigImage(imageName: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${imageName}`, method: urlObj.method });
  }
  ...
  withdrawalHistory(kitchenId: any, pageNo: any, pageCount: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${kitchenId}/${pageNo}/${pageCount}`, method: urlObj.method });
  }

  getCustomerPastOrders(customerId: any, pageNo: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.getCustomerPastOrders;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${customerId}/${pageNo}/${this.getTodayStartDate()}`, method: urlObj.method });
  }

  getCustomerPackageList(customerId: any, pageNo: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.getCustomerPackageList;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${customerId}/${pageNo}`, method: urlObj.method });
  }
  ...
  getCustomerWalletBalance(customerId: string) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${customerId}`, method: urlObj.method });
  }
  ...
  getCurrentBulkOrdersList(page: any, limit: number) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${limit}`, method: urlObj.method });
  }
  ...
  getCurrentPackageCount() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getCurrentPackageCount);
  }

  updatePackageFoodOrder(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.updatePackageFoodOrder, data);
  }

  updatePackageRouteInfo(id: string, data: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.updatePackageRouteInfo;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, data);
  }

  createDailyPackageOrder(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createDailyPackageOrder, data);
  }

  performPackageOrderTransfer(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.performPackageOrderTransfer, data);
  }
  ...
  getKitchenPastPackageOrders(kitchenId: any, page: number) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${kitchenId}/${page}`, method: urlObj.method });
  }
  ...
  exportFoodOrderList(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.exportFoodOrderList, data);
  }

  exportFoodOrderPackageList(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.exportFoodOrderPackageList, data);
  }

  getKitchenAssignedOrders(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getKitchenAssignedOrders, data);
  }

  deductkitchenWallet(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.deductkitchenWallet, data);
  }

  addkitchenWallet(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.addkitchenWallet, data);
  }

  exportCustomerList(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.exportCustomerList, data);
  }
  ...
  saveBulkFoodItem(payload: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.saveBulkFoodItem, payload, null, false, true);
  }
  ...
  getAllBulkFooditems() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getAllBulkFooditems, null, null, false, true);
  }
  ...
  bulkMenuAdd(payload: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.bulkMenuAdd, payload, null, false, true);
  }

  updateBulkMenu(payload: any, id: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.updateBulkMenu, payload, null, false, true);
  }

  getBulkOrderList(status: any, page: any, limit: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.getBulkOrderList;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${limit}/${this.getTodayStartDate()}/${status}`, method: urlObj.method });
  }

  updateBulkFoodOrder(order: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.updateBulkFoodOrder, order);
  }
  ...
  changeChildOrdersAddress(payload: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.changeChildOrdersAddress, payload);
  }

  changePackageStatus(status: any, id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.changePackageStatus;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, { status });
  }

  getCustomerFirstOrder(payload: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getCustomerFirstOrder, { ids: payload });
  }
  ...
  getAllMarketplaceItems() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getAllMarketplaceItems);
  }
  ...
  getClusterCurrentOrdersList(status: any, page: any, limit: number, data: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${limit}/${status}`, method: urlObj.method }, data);
  }
  ...
  deleteMarketPlaceItemImage(id: any, imageUrl: string) {
    const fileName = imageUrl.split('/').pop();
    const urlObj = this.apiConfigService.apiEndPointObj.deleteMarketPlaceItemImage;
    return this.apiHttpService.REQUEST({ url: `${urlObj.url}/${id}/${fileName}`, method: urlObj.method });
  }
  ...
  getMarketPlaceItemOrdersCountByInventoryId(id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.getMarketPlaceItemOrdersCountByInventory;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }
  ...
  getMarketPlaceItemOrdersListByInventoryId(status: any, page: any, limit: any, id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.getMarketPlaceItemOrdersListByInventoryId;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${status}/${page}/${limit}`, method: urlObj.method });
  }
  ...
  generateShipRocketAWB(shipment_id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.generateShipRocketAWB;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${shipment_id}`, method: urlObj.method });
  }

  requestShipRocketPickUp(shipment_id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.requestShipRocketPickUp;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${shipment_id}`, method: urlObj.method });
  }
  ...
  createShipWayDeliveryTask(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createShipWayDeliveryTask, data);
  }

  trackShipWayDeliveryTask(taskId: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.trackShipWayDeliveryTask;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${taskId}`, method: urlObj.method });
  }

  cancelShipWayDeliveryTask(taskId: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.cancelShipWayDeliveryTask;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${taskId}`, method: urlObj.method });
  }
  ...
  getCombineOrderForDeliveryByInventoryId(status: any, id: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.getCombineOrderForDeliveryByInventoryId;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${status}/${id}`, method: urlObj.method });
  }
  ...
  getUtmEvents(cluster_name: any) {
    ...
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${cluster_name}`, method: urlObj.method });
  }

  getUtmEventsAdminData(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getUtmEventsAdminData, data);
  }

  getCustomerMarketPlaceItemPastOrders(id: any, page: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.getCustomerMarketPlaceItemPastOrders;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}/${page}`, method: urlObj.method });
  }

  getClusterVariablesnameList() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getClusterVariablesnameList);
  }

  searchClusterVariable(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.searchClusterVariable, data);
  }

  saveUpdateClusterVariable(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.saveUpdateClusterVariable, data);
  }

  createBlogCategory(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createBlogCategory, data);
  }

  getAllBlogCategories(page: number, pageSize: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.getAllBlogCategories;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${pageSize}`, method: urlObj.method });
  }

  deleteBlogCategory(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.deleteBlogCategory;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  getBlogCategoryById(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getBlogCategoryById;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  updateBlogCategory(id: string, data: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.updateBlogCategory;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, data);
  }

  getCategoryNameBlogCategory(pathName: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getCategoryNameBlogCategory;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${pathName}`, method: urlObj.method });
  }

  createBlogAuthor(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createBlogAuthor, data);
  }

  getAllBlogAuthors(page: number, pageSize: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.getAllBlogAuthors;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${pageSize}`, method: urlObj.method });
  }

  deleteBlogAuthor(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.deleteBlogAuthor;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  getBlogAuthorById(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getBlogAuthorById;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  updateBlogAuthor(id: string, data: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.updateBlogAuthor;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, data);
  }

  getBlogAuthorByPathName(pathName: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getBlogAuthorByPathName;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${pathName}`, method: urlObj.method });
  }

  getAllAuthorNames() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getAllAuthorNames);
  }

  getCategoryNames() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getCategoryNames);
  }

  createBlog(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createBlog, data);
  }

  getAllBlogs(page: number, pageSize: number, status: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getAllBlogs;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${pageSize}/${status}`, method: urlObj.method });
  }

  deleteBlog(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.deleteBlog;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  publishBlog(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.publishBlog;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  updateStatus(id: string, status: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.updateStatus;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, { status });
  }

  getBlogById(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getBlogById;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  updateBlog(id: string, data: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.updateBlog;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, data);
  }

  searchBlogsByName(search: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.searchBlogsByName;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${search}`, method: urlObj.method }, null, null, true);
  }

  getAllMetaManagements(page: number, pageSize: number) {
  ...
  getMarketPlaceItemReviews(page: number, pageSize: number) {
    const urlObj = this.apiConfigService.apiEndPointObj.getMarketPlaceItemReviews;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${page}/${pageSize}/null/null`, method: urlObj.method });
  }

  getAdminMarketPlaceItemReviews(params: { page: number; pageSize: number; search?: string; verified?: string; pinned?: string; date?: string; }) {
    const urlObj = this.apiConfigService.apiEndPointObj.getAdminMarketPlaceItemReviews;
    const { page, pageSize, ...filters } = params;
    const query = new URLSearchParams(filters as Record<string, string>).toString();
    const fullUrl = `${urlObj.url}/${page}/${pageSize}${query ? `?${query}` : ''}`;
    return this.apiHttpService.REQUEST({ url: fullUrl, method: urlObj.method, });
  }

  getMarketPlaceItemReviewById(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.getMarketPlaceItemReviewById;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  createMarketPlaceItemReview(payload: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.createMarketPlaceItemReview, payload);
  }

  updateMarketPlaceItemReview(id: string, payload: any) {
    const urlObj = this.apiConfigService.apiEndPointObj.updateMarketPlaceItemReview;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, payload);
  }

  deleteMarketPlaceItemReview(id: string) {
    const urlObj = this.apiConfigService.apiEndPointObj.deleteMarketPlaceItemReview;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method });
  }

  setPinnedMarketPlaceItemReview(id: string, pinned: boolean) {
    const urlObj = this.apiConfigService.apiEndPointObj.setPinnedMarketPlaceItemReview;
    return this.apiHttpService.REQUEST({ url: urlObj.url + `/${id}`, method: urlObj.method }, { pinned });
  }

  setVerifiedMarketPlaceItemReview(id: string, verified: boolean) {
  ...
  getAllConfigVideos() {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.getAllConfigVideos);
  }

  saveConfigVideo(data: any) {
    return this.apiHttpService.REQUEST(this.apiConfigService.apiEndPointObj.saveConfigVideo, data);
  }
