"use strict";
(self["webpackChunkdashboardAdmin"] = self["webpackChunkdashboardAdmin"] || []).push([["default-src_service_excel_service_ts"],{

/***/ 90921:
/*!**************************************!*\
  !*** ./src/service/excel.service.ts ***!
  \**************************************/
...
/* harmony export */ });
/* harmony import */ var xlsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! xlsx */ 82002);
...
class ExcelService {
  ...
  download(data, type) {
    try {
      ...
      var ws = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.json_to_sheet(data);
      ...
      xlsx__WEBPACK_IMPORTED_MODULE_0__.writeFile(wb, filename);
    } catch (error) {
    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = e => {
        try {
          ...
          const wb = xlsx__WEBPACK_IMPORTED_MODULE_0__.read(bstr, {
            type: 'binary'
          });
          const wsname = wb.SheetNames[0];
          const ws = wb.Sheets[wsname];
          const data = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.sheet_to_json(ws, {
            header: 1
          });
          resolve(data);
        } catch (error) {
...
//# sourceMappingURL=default-src_service_excel_service_ts.js.map